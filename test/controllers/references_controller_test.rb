...
class ReferencesControllerTest < ActionController::TestCase
  ...
  test "should create reference" do
    assert_difference('Reference.count') do
      post :create, reference: { author: @reference.author, date: @reference.date, notes: @reference.notes, title: @reference.title, url: @reference.url }
    end
  ...
  test "should update reference" do
    patch :update, id: @reference, reference: { author: @reference.author, date: @reference.date, notes: @reference.notes, title: @reference.title, url: @reference.url }
    assert_redirected_to reference_path(assigns(:reference))
  end
